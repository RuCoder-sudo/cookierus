...
class CookieRus_Updater {

    private $github_user = 'RuCoder-sudo';
    private $github_repo = 'cookierus';
    private $plugin_file;
    private $plugin_slug;
    ...
    public function __construct( $plugin_file, $current_version ) {
        ...
        $this->cache_key       = 'cookierus_github_update';

        // Одноразовый сброс старого кэша проверки обновлений
        if ( get_option( 'cookierus_updater_cache_reset_v1' ) !== '1' ) {
            delete_transient( $this->cache_key );
            delete_site_transient( 'update_plugins' );
            update_option( 'cookierus_updater_cache_reset_v1', '1' );
        }
