...
<div class="cr-imp-wrap">
    ...
    <div class="cr-imp-section" id="cr-policy">
        ...
        <div class="cr-tips-grid">
            <div class="cr-tip-card">
                <strong>✅ Актуальная политика</strong>
                Разместите собственную политику конфиденциальности на постоянном URL и обновляйте её при добавлении сервисов, категорий или целей обработки.
            </div>
            <div class="cr-tip-card">
    ...
    <div class="cr-imp-section" id="cr-owner-responsibility" style="border:2px solid #dc2626;background:#fff7ed;">
        <h2 style="color:#b91c1c;"><span class="dashicons dashicons-warning"></span> ВАЖНО: ответственность владельца сайта</h2>
        <p style="font-size:15px;font-weight:700;color:#7f1d1d;">
            Разработчик сайта и плагина не несёт ответственности за соответствие конкретного сайта требованиям законодательства.
            Вся ответственность за содержание сайта, подключённые сервисы, состав обрабатываемых данных, тексты политики,
            получение согласий и соблюдение закона лежит на владельце сайта и операторе персональных данных.
        </p>
        <p>Перед публикацией проверьте фактические трекеры, формы, цели обработки, договоры с подрядчиками и документы сайта с юристом.</p>
    </div>
